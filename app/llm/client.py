...
from app.llm.anthropic import handle_anthropic_api
from app.llm.chat_completions import handle_chat_completions_api, prepare_messages
from app.llm.responses_api import handle_responses_api
from app.llm.tooling import ToolRegistry
...
class AsyncLLMClient:
    ...
    def _prepare_messages(self, user_input, instructions=None):
